...
<body>
    ...
    if (empty($nameErr) && empty($emailErr) && empty($mobileErr) && empty($websiteErr) && empty($genderErr)) {
        ...
        $sql = "INSERT INTO register (Name, Email, Mobileno, Website, Gender) VALUES ('$name', '$email', '$mobile', '$website', '$gender')";
